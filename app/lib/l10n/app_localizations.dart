...
abstract class AppLocalizations {
  ...
  /// No description provided for @traditionalEvents.
  ///
  /// In en, this message translates to:
  /// **'Traditional Events'**
  String get traditionalEvents;

  /// No description provided for @customEvents.
  ///
  /// In en, this message translates to:
  /// **'Custom Events'**
  String get customEvents;
  ...
  /// No description provided for @ji.
  ///
  /// In en, this message translates to:
  /// **'Ji (Bad for)'**
  String get ji;

  /// No description provided for @solarTerm.
  ///
  /// In en, this message translates to:
  /// **'Solar Term'**
  String get solarTerm;
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['en', 'id', 'zh'].contains(locale.languageCode);
